...
namespace PhotoTool
{
    public partial class SlideShowDialog : Form
    {
        ...
        private void InitializeForm()
        {
            ...
            Bitmap bmp = PhotoTool.Properties.Resources.NextBitmap;
            bmp.MakeTransparent(Color.White);
            btnNext.Image = bmp;
            bmp = PhotoTool.Properties.Resources.PrevBitmap;
            bmp.MakeTransparent(Color.White);
            btnPrev.Image = bmp;
            trackAlbum.Maximum = Manager.Album.Count - 1;
            UpdateDialog();
            // Assign sound for slide show
            _soundPlayer = new SoundPlayer( PhotoTool.Properties.Resources.DingSound);
        }
