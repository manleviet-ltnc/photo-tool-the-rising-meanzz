...
namespace Manning.MyPhotoAlbum
{
    public class AlbumStorageException:Exception
    {
        ...
        public AlbumStorageException(string msg) : base() { }
    ...
    public class AlbumStorage
    {
        ...
        static public void WriteAlbum(PhotoAlbum album, string path, string password)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    cw.WriteUnencryptedLine(
                    CurrentVersion.ToString() + 'e');
            ...
            {
                throw new AlbumStorageException("Unalbe to access album" + path, uax);
            }
            finally
            {
                if (sw != null)
        ...
        static public PhotoAlbum ReadAlbum(string path, string password)
        {
            ...
            try
            {
                ...
                {
                   case "63":
                      ReadAlbumV63(sr, album); break;
                    case "91":
                    case "91e":
                      ReadAlbumV91(sr, album); break;
                    default:
        ...
        static private void ReadAlbumV91(StreamReader sr, PhotoAlbum album)
        {
            ...
            album.PhotoDescriptor= (PhotoAlbum.DescriptorOption)Enum.Parse(typeof(PhotoAlbum.DescriptorOption),
                                    enumVal);
